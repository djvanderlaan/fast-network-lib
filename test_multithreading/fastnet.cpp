...
BENCHMARK(BM_threaded)->Args({10000000, 1})->Args({10000000, 2})->UseRealTime();
BENCHMARK(BM_async)->Args({10000000, 1})->Args({10000000, 2})->UseRealTime();
BENCHMARK(BM_single)->Args({10000000, 1})->UseRealTime();
